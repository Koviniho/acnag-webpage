...
export const StickyScroll = ({
  ...
  return (
    <motion.div
     a-aos-offset="200" className="h-screen overflow-y-auto custom-about-gradient flex justify-center relative space-x-10  scrollba"
      ref={ref}
    >
      <div className="div relative flex items-start px-4 " data-aos="fade-up">
        <div className="max-w-2xl ">
          {content.map((item, index) => (
            <div key={item.title + index} className="md:my-20 my-16 ">
              <motion.h2 data-aos="zoom-in"  data-aos-delay="300"
                initial={{
                  opacity: 0,
                }}
                animate={{
