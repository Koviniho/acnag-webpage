...
function ImagePresenter() {
    const data = [
        { heading: "Collection", subHeading: "Carrosserie", buttonTitel: "EXPLORE", src: '/Home/image_block (1).png' },
        { heading: "Magzin", subHeading: "Reperaturen & Service", buttonTitel: "EN SAVIOR PLUS", src: '/Home/image_block (3).png' },
        { heading: "Corso Pilota", subHeading: "Spritzwerk", buttonTitel: "EN SAVIOR PLUS", src: '/Home/image_block (2).png' },
        { heading: "Ferrari Approved", subHeading: "An & Verkauf", buttonTitel: "Verkaufseite", src: '/Home/image_block.png' },
    ];
