...
function Content({ GetValue }) {
  ...
  return (
    <motion.div ref={ref}>
      <div className='flex flex-col h-auto w-screen gap-3 text-white md:pt-5 z-50'>
        ...
        <div className='max-w-screen md:h-[120vh] md:overflow-hidden custom-gradient p-3'>
          <div className='text-[red] text-lg font-light mb-2'>Standort</div>
          <div className='flex md:flex-row flex-col h-auto w-screen gap-8 md:max-w-[98%] md:justify-around'>
            <MusiamCard name={'Auto Center Niederbipp'} conact={'+910101001'} mail={'info@acnag.ch'} adress={'new street old house no 125'} src={'/Contact/musiam (2).jpeg'} />
            <MusiamCard name={'Auto Center Zollikofen'} conact={'+910101001'} mail={'contact@gmail.com'} adress={'new street old house no 125'} src={'/Contact/musiam (1).jpeg'} />
          </div>
        </div>
      </div>
    </motion.div>
  ...
  return (
    <div className='flex flex-col w-[90%] md:w-[80%] md:h-[90%] gap-4 overflow-hidden custom-gradient '>
      ...
      <div className='p-3 flex flex-col md:gap-1 gap-3'>
        ...
        <div className='flex flex-col w-full gap-1'>
          <div className='flex text-sm md:text-xl'>Montag <div className='flex-grow justify-end flex text-sm md:text-xl'>09.30 - 19.00</div></div>
          <div className='flex text-sm md:text-xl'>Dienstag <div className='flex-grow justify-end flex text-sm md:text-xl'>09.00 - 19.00</div></div>
          <div className='flex text-sm md:text-xl'>Mittwoch<div className='flex-grow justify-end flex text-sm md:text-xl'>09.00 - 19.00</div></div>
          <div className='flex text-sm md:text-xl'>Donnerstag<div className='flex-grow justify-end flex text-sm md:text-xl'>09.30 - 18.00</div></div>
          <div className='flex text-sm md:text-xl'>Freitag<div className='flex-grow justify-end flex text-sm md:text-xl'>09.30 - 18.00</div></div>
          <div className='flex text-sm md:text-xl'>Samstag<div className='flex-grow justify-end flex text-sm md:text-xl'>09.30 - 18.00</div></div>
          <div className='flex text-sm md:text-xl'>Sonntag<div className='flex-grow justify-end flex text-sm md:text-xl'>Geschlossen</div></div>
