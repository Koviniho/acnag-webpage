    ...
    <div className="w-screen h-auto flex flex-col overflow-x-hidden text-white items-center">
      ...
      <div className='w-full relative  text-white'>
        ...
        <div className='absolute w-[30%] flex flex-col gap-3 top-[50%] translate-y-[-50%] left-[10%]'>
          <p className='text-2xl font-bold'>Hauptzentrale</p>
          <div className='flex flex-col w-full'>
            <p className='font-extrabold md:text-5xl text-3xl'>Auto Center Niederbipp</p>
          </div>
          <div className='flex flex-col gap-1'>
            <p className='text-xl font-medium'>Leenrütimattweg 3, 4704 Niederbipp</p>
            <p className='text-xl font-medium'>+032 633 00 63</p>
          </div>
        </div>
      </div>
      {/* Filter */}
