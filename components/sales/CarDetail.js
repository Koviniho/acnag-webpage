...
function CarDetail({ data, onClick }) {
  ...
  return (
    ...
    <div className='flex  flex-col w-[85vw] h-auto gap-2 text-white'>
      <button
        className='md:w-[20%] w-[60%] py-2 font-bold text-blue-500 flex items-center mt-2 hover:scale-105'
        onClick={onClick}
      >
      ...
      <div className='md:flex hidden w-full h-auto gap-2 '>
        ...
        <div className='w-1/2 h-full flex flex-col px-16 relative '>
          {/* 2nd half */}
          <CarInfo data={data} />
          <div className='flex md:flex-col md:w-full md:h-[63vh] absolute px-6 bottom-0 left-0 py-2 gap-4 rounded-md custom-gradient'>
...
const FinalDetails = ({ data }) => {
  return (
    <div className='h-full w-full flex p-3 flex-col text-[#ddd8d8] gap-4 mt-2  custom-gradient
     rounded-md'>
      <div className='text-2xl md:text-4xl font-light'> FAHRZEUGDATEN </div>
      <div className='flex flex-col gap-1'>
        <div className='flex text-xl'>
          Aufbau
...
const CarInfo = ({ data }) => {
  return (
    ...
    <div className='flex flex-col jusify-center w-full h-[65%] gap-3 text-white mb-2'>
